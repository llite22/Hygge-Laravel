...
<head>
    ...
    <link href="{{asset('type/icons.css')}}" rel="stylesheet">
...
<div class="body-wrapper">
        ...
        <div class="container">
            <div class="navbar-header">
                <div class="basic-wrapper"> <a class="btn responsive-menu" data-toggle="collapse" data-target=".navbar-collapse"><i></i></a>
                    <div class="navbar-brand"> <a href="index.html"><img src="#" srcset="images/logo.png 1x, images/logo@2x.png 2x" class="logo-light" alt="" /><img src="#" srcset="images/logo-dark.png 1x, images/logo-dark@2x.png 2x" class="logo-dark" alt="" /></a>
                    </div>
                    <!-- /.navbar-brand -->
                </div>
                <!-- /.basic-wrapper -->
    ...
    <div class="tp-fullscreen-container revolution">
        <div class="tp-fullscreen">
            <ul>
                <li data-transition="fade"> <img src="{{asset('images/art/slider-bg1.jpg')}}"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
                ...
                <li data-transition="fade"> <img src="{{asset('images/art/slider-bg2.jpg')}}"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
                ...
                <li data-transition="fade"> <img src="{{asset('images/art/slider-bg3.jpg')}}"  alt="" data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat" />
    ...
    <div class="light-wrapper">
        <div class="container inner">
            ...
            <div class="row services">
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-web-browser.png')}}" alt="img" /> </div>
                ...
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-paint-palette.png')}}" alt="img" /> </div>
                        <h4>Color Palette</h4>
                        <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo.</p>
                    </div>
                    <!--/.service -->
                ...
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-coding.png')}}" alt="img" /> </div>
                        <h4>Clear Coding</h4>
                        <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo.</p>
                    </div>
                    <!--/.service -->
            ...
            <div class="row services">
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-chats.png')}}" alt="img" /> </div>
                ...
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-tv.png')}}" alt="img" /> </div>
                        <h4>Video Support</h4>
                        <p>Morbi leo risus, porta ac consectetur ac, vestibulum at eros. Fusce dapibus, tellus ac cursus commodo.</p>
                    </div>
                    <!--/.service -->
                ...
                <div class="col-sm-4">
                    <div class="service text-center">
                        <div class="icon"> <img src="{{asset('images/icons/lulu-clipboard.png')}}" alt="img" /> </div>
...
{{--swfswfwwefwe--}}
    <div class="inverse-wrapper inner bp0">
        <div class="container">
            <div class="thin text-center">
                ...
                <div class="divide30"></div>
                <figure>
                    <img src="{{asset('images/art/hygge.png')}}" alt="img" />
                </figure>
            </div>
            <!-- /.thin -->
            ...
            <div class="cbp-panel">
                ...
                <div id="grid-container" class="cbp">
                    <div class="cbp-item print motion"> <a href="ajax/project1.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p1.jpg')}}" alt="img" /> </div>
                    ...
                    <div class="cbp-item web logo"> <a href="ajax/project2.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p2.jpg')}}" alt="img" /> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item print motion"> <a href="ajax/project3.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p3.jpg')}}" alt="img" /> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item web print"> <a href="ajax/project4.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p4.jpg"')}}" alt="img" /> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item motion logo"> <a href="ajax/project5.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p5.jpg')}}" alt="img" /> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                    ...
                    <div class="cbp-item print motion"> <a href="ajax/project6.html" class="cbp-caption cbp-singlePageInline">
                            <div class="cbp-caption-defaultWrap"> <img src="{{asset('images/art/p6.jpg')}}" alt="img" /> </div>
                            <div class="cbp-caption-activeWrap">
                                <div class="cbp-l-caption-alignCenter">
                                    <div class="cbp-l-caption-body">
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-5">
                                    <figure><a href="#">
                                            ...
                                            <img src="{{asset('images/art/tb1.jpg')}}" alt="img" /></a></figure>
                                </div>
                                <!-- /column -->
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-5">
                                    <figure><a href="#">
                                            ...
                                            <img src="{{asset('images/art/tb2.jpg')}}" alt="img" /></a></figure>
                                </div>
                                <!-- /column -->
                                <div class="col-sm-9 col-md-7">
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-5">
                                    <figure><a href="#">
                                            ...
                                            <img src="{{asset('images/art/tb5.jpg')}}" alt="img" /></a></figure>
                                </div>
                                <!-- /column -->
                                <div class="col-sm-9 col-md-7">
                            ...
                            <div class="row">
                                <div class="col-sm-3 col-md-5">
                                    <figure><a href="#">
                                            ...
                                            <img src="{{asset('images/art/tb6.jpg')}}" alt="img" /></a></figure>
                                </div>
                                <!-- /column -->
                                <div class="col-sm-9 col-md-7">
    ...
    <div class="white-wrapper">
        <div class="col-image">
            <div class="bg-wrapper col-md-6">
                <div class="bg-holder" style="background-image: url(images/art/about.jpg);"></div>
            </div>
            <!--/.bg-wrapper -->
            <div class="container">
                <div class="row">
        ...
        <div class="container inner">
            ...
            <div class="row grid-view">
                <div class="col-sm-3 text-center">
                    <figure><img src="{{asset('images/art/t1.jpg')}}" alt="" /></figure>
                ...
                <!-- /column -->
                <div class="col-sm-3 text-center">
                    <figure><img src="{{asset('images/art/t2.jpg')}}" alt="" /></figure>
                ...
                <!-- /column -->
                <div class="col-sm-3 text-center">
                    <figure><img src="{{asset('images/art/t3.jpg')}}" alt="" /></figure>
                ...
                <!-- /column -->
                <div class="col-sm-3 text-center">
                    <figure><img src="{{asset('images/art/t4.jpg')}}" alt="" /></figure>
    ...
    <footer class="inverse-wrapper">
        <div class="container inner">
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="widget"> <img src="{{asset('images/logo.png')}}" data-at2x="{{asset('images/logo@2x.png')}}" alt="img" />
