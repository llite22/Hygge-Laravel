<footer class="inverse-wrapper">
    <div class="container inner">
        <div class="row">
            ...
            <div class="col-sm-4">
                ...
                <div class="tagcloud"><a href="#" style="font-size: 9pt;">blogroll</a> <a href="#"
                    ...
                    <a href="#" style="font-size: 9pt;">dialog</a> <a href="#" style="font-size: 9pt;">gallery</a> <a
                        href="#" style="font-size: 10pt;">journal</a> <a href="#" style="font-size: 9pt;">link</a> <a
                        href="#" style="font-size: 12pt;">motion</a> <a href="#" style="font-size: 9pt;">music</a> <a
                        href="#" style="font-size: 20pt;">photo</a> <a href="#"
                                                                       style="font-size: 13pt;">professional</a> <a
                        href="#" style="font-size: 16pt;">quotation</a> <a href="#" style="font-size: 9pt;">show</a> <a
                        href="#" style="font-size: 15pt;">sound</a></div>
            </div>
        </div>
        <hr/>
        <div class="row">
            <div class="col-sm-3">
                <div class="widget"><img src="{{asset('images/logo.png')}}" data-at2x="{{asset('images/logo@2x.png')}}"
                                         alt="img"/>
        ...
        <hr/>
        <p class="copyright pull-left">© 2015 Hygge. All rights reserved. Theme by <a href="http://elemisfreebies.com">elemis</a>.
        </p>
